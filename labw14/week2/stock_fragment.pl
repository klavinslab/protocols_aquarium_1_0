step
  description: "Find the fragment tube you made that still stays on your bench"
end

step
  description: "Move it to the next available spot in M20.0.0.x"
  note: "Record the location you put"
end
