argument
  fragments_array: sample array("Yeast cDNA"),"The cDNA samples to run in qPCR"
  enzyme: sample("Enzyme Stock"), "The iTaq Universal SYBR Green Supermix"
  primers_forward_array: sample array("Primer Aliquot"), "The forward primers"
  primers_reverse_array: sample array("Primer Aliquot"), "The reverse primers"
