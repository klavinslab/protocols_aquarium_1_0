...
step
  description: "Prepare %{volume} mL of %{media} media with the desired antibiotics"
  check: "Attach the 25mL tip to the serological pipetter"
  check: "Use the electric serological pipette to add  %{volume} mL of %{media} into the 50mL falcon tube"
  check: "Dispose of your 25mL serological pipette tip in tip waste"
  check: "Pipette %{ab_vol1} uL of %{antibio1} to the solution"
  check: "Pipette %{ab_vol2} uL of %{antibio2} to the solution"
