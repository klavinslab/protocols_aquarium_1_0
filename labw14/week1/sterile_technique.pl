...
step
  description: "Take out 1 1.5 mL tube from 1.5 mL Tube Box."
  note:
  "When taking a tube out of the box, make sure to only touch the tube you want, and do not touch the inside of
...
step
  description: "Practice opening and closing the cap of the 1.5 mL tube with one hand."
  note:
  "Hold the tube in one hand (your non-dominant hand, because your dominant hand will be used for pipetting) 
