...
step
  ...
  note:
  "This is a wet lab that works with live cultures. Do not bring food or drinks into the lab, 
...
step
  ...
  note:
  "Before leaving the lab, immediately following contact with potentially infectious agents, 
...
step
  ...
  note:
  "Be aware when using flammable reagents. In case of a serious fire call 911. No smoking in the lab."
...
step
  description:
  "All biologically contaminated disposables must be disposed in the biohazard waste."
  note:
...
step
  description:
  "When using flammable, acidic, or basic reagents the chemicals MUST be used within the fume hood with the sash as low as possible."
  note:
...
step
  description:
  "In case of a cut, burn, or other health concern that arises while in the lab use one of the first aid kits."
  note:
...
step
  description:
  "All broken glassware must be disposed of in broken glass container."
  note:
...
step
  description:
  "Sharps, such as needles, scalpels, microscope slides, razor blades etc. must be disposed of in sharps container."
  note:
...
step
  description:
  "All dirty glassware should be cleaned at the dishwashing station"
  note:
...
step
  description:
  "UV Shield must be used when using UV transilluminator."
  note:
...
step
  description:
  "Gloves must be used when using potentially dangerous chemicals."
  note:
