...
step
  ...
  note: "Use your Pipettor P1000 (100-1000 μL pipettor) to remove any remaining supernatant from each 50 mL tube. Be careful not to desturb the pellet."
...
step
  ...
  note: "Use your Pipettor P1000 (100-1000 μL pipettor) to add 1 mL ice cold molecular grade water to each 50 mL tube. Resuspend each pellet by gently pipetting up and down."
end

step
  description: "Transfer into one of the prechilled 1.5 mL centrifuge tubes."
  note: "Using your Pipettor P1000 (100-1000 μL pipettor), transfer the culture from each 50 mL Falcon tube to one of the 1.5 mL centrifuge tubes on ice."
end
