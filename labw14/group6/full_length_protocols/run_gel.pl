...
step
  ...
  note: "Using a 100 µL pipetter, pipet %{fragment_volume} µL of PCR results (containing loading dye) into the second (id %{assemblies1}) and third well (id %{assemblies2} of the gel."
  image: "gel_begin_loading"
end
