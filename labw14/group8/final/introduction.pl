step
  ...
  note: "You combine  several fragments with overlapping regions into
    ...
    be stiched back together. 
    This technique was published in 2009."
end

#todo add image from original paper
...
step
  ...
  bullet: "Day 2"
  bullet: "Image the plates to check the colony counts (measure of success)"
  bullet: "For Gibsons that didn't work, the person who wanted them done will try to troubleshoot what went wrong.
