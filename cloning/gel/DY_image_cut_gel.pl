argument
  gel_lane: sample("fragment") array, "The gel lanes you got after running the gel"
end
...
step
  description: "Take the gel(s) out of gel box(s) and put the first one on the transilluminator"
...
step
  description: "If you have more than one gel, repeat this process for each gel"
end
