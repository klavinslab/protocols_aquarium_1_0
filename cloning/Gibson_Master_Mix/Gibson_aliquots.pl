...
argument
  ...
  t5: sample("Enzyme Stock"), "Choose a tube T5 Exonuclease to use in this protocol."
  phusion_pol: sample("Enzyme Stock"), "Choose a tube of phusion polymerase to use in this protocol."
