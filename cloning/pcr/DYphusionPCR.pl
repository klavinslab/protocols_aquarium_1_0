argument
  ...
  primer1/2: sample, "The second primer: reaction 1"
  plasmid.1: sample, "The plasmid stock: reaction 1"
  primer2@1: sample, "The first primer: reaction 2"
  primer2$2: sample, "The second primer: reaction 2"
  plasmid2: sample, "The plasmid stock: reaction 2"
  primer3*1: sample, "The first primer: reaction 3"
