argument
  ...
  primer1x1: sample("Primer"), "Forward primer: reaction 1"
  primer1x2: sample("Primer"), "Reverse primer: reaction 1"
  plasmid1: sample("Plasmid"), "Template: reaction 1"
  primer2x1: sample("Primer"), "Forward primer: reaction 2"
  primer2x2: sample("Primer"), "Reverse primer: reaction 2"
  plasmid2: sample("Plasmid"), "Template: reaction 2"
  primer3x1: sample("Primer"), "Forward primer: reaction 3"
  primer3x2: sample("Primer"), "Reverse primer: reaction 3"
  plasmid3: sample("Plasmid"), "Template: reaction 3"
  primer4x1: sample("Primer"), "Forward primer: reaction 4"
  primer4x2: sample("Primer"), "Reverse primer: reaction 4"
  plasmid4: sample("Plasmid"), "Template: reaction 4"
  primer5x1: sample("Primer"), "Forward primer: reaction 5"
  primer5x2: sample("Primer"), "Reverse primer: reaction 5"
  plasmid5: sample("Plasmid"), "Template: reaction 5"
  primer6x1: sample("Primer"), "Forward primer: reaction 6"
  primer6x2: sample("Primer"), "Reverse primer: reaction 6"
  plasmid6: sample("Plasmid"), "Template: reaction 6"
  primer7x1: sample("Primer"), "Forward primer: reaction 7"
  primer7x2: sample("Primer"), "Reverse primer: reaction 7"
  plasmid7: sample("Plasmid"), "Template: reaction 7"
  primer8x1: sample("Primer"), "Forward primer: reaction 8"
  primer8x2: sample("Primer"), "Reverse primer: reaction 8"
  plasmid8: sample("Plasmid"), "Template: reaction 8"
  primer9x1: sample("Primer"), "Forward primer: reaction 9"
  primer9x2: sample("Primer"), "Reverse primer: reaction 9"
  plasmid9: sample("Plasmid"), "Template: reaction 9"
  primer10x1: sample("Primer"), "Forward primer: reaction 10"
  primer10x2: sample("Primer"), "Reverse primer: reaction 10"
  plasmid10: sample("Plasmid"), "Template: reaction 10"
  primer11x1: sample("Primer"), "Forward primer: reaction 11"
  primer11x2: sample("Primer"), "Reverse primer: reaction 11"
  plasmid11: sample("Plasmid"), "Template: reaction 11"
  primer12x1: sample("Primer"), "Forward primer: reaction 12"
  primer12x2: sample("Primer"), "Reverse primer: reaction 12"
  plasmid12: sample("Plasmid"), "Template: reaction 12"
end
