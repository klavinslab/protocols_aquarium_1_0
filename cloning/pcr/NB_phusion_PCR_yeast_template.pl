argument
  ...
  template_ids: sample("Yeast") array, "Yeast Lysate Templates"
...
take
    yeast_stock = item unique(template_ids)
end
...
while x < y
  ...
  z=x+1
  step
    description: "Pipet 1 µL of yeast lysate with id %{a} into well %{z}."
  end
  x = x+1
end
