...
class Protocol
  def main
    show {
      ...
      note "Always hold a pipette with one hand. Grab the body of the pipette with your palm and fingers, with your thumb 
    ...
    show {
      title "Understand the difference between the three pipettes."
    ...
    show {
      title "Understand the maxiumum volume of each pipette."
    ...
    show {
      title "Practice changing the volume of the pipette."
      note "The current volume of a pipette is read from the number screen, from top to bottom. The actual volume
    ...
    show {
      title "Practice putting a tip on the pipette."
      note "Grab one of the pipettes and its corresponding tip box. Holding the pipette in your dominant hand, open the
    ...
    show {
      title "Practice pressing the button."
      note "There are two stopping points when pressing the button on top of the pipette. Practice pressing the button.
    ...
    show {
      title "Practice drawing up and releasing liquid."
      note "Fill a 1.5 mL tube with water from the sink. For good practice, maintain a sterile technique when using this
