...
step
  ...
  note: "Invert the plate so the beads are on the agar surface. 
         Add %{volume} µL of sample using the P1000 micropipettor 
...
step
  ...
  note: "Use 3-4 sharp shakes, then pour the beads out into the waste bead container. 
