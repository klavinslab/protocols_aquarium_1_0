argument
  gel: sample array, "The gel lane you got after run the gel"
end
...
step
  description: "Remove the camera hood, cut out the gel slice with desired length." 
  note: "It may help to turn the romm lights off during this step. Use the ladder to locate where
  1799bp is. Use the razor blade to cut around the band."
  image: "cut_gel"
end
...
step
  description: 
    "Rename the picture in Dropbox （Skip this step for now, the camera uplooding is not working now)"
  note: 
